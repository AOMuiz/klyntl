...
// import { StoreConfigRepository } from "./StoreConfigRepository";
...
//       const storeConfig = await repositories.storeConfigRepository.getActiveConfig();
//       if (!storeConfig) {
...
//    */
//   private static async validateDatabaseSchema(db: SQLiteDatabase): Promise<void> {
...
//     return Math.abs(db.toString().split('').reduce((a, b) => {
...
//       } catch (error) {
//         errors.push(`Customer repository: ${error instanceof Error ? error.message : String(error)}`);
//       }
...
//       } catch (error) {
//         errors.push(`Product repository: ${error instanceof Error ? error.message : String(error)}`);
//       }
...
//       } catch (error) {
//         errors.push(`Transaction repository: ${error instanceof Error ? error.message : String(error)}`);
//       }
...
//       } catch (error) {
//         errors.push(`Store config repository: ${error instanceof Error ? error.message : String(error)}`);
//       }
...
//         isHealthy: false,
//         repositories,
//         errors: [...errors, `Health check failed: ${error instanceof Error ? error.message : String(error)}`],
//       };
//     }
//   }
...
//     db: SQLiteDatabase,
//     operations: {
//       customers?: Array<{ operation: 'create' | 'update' | 'delete'; data: any; id?: string }>;
//       products?: Array<{ operation: 'create' | 'update' | 'delete'; data: any; id?: string }>;
//       transactions?: Array<{ operation: 'create' | 'update' | 'delete'; data: any; id?: string }>;
//     }
//   ): Promise<{
//     success: boolean;
//     results: {
...
//               switch (op.operation) {
//                 case 'create':
//                   const customer = await repos.customerRepository.createWithValidation(op.data);
//                   results.customers.push(customer);
//                   break;
//                 case 'update':
//                   if (!op.id) throw new ValidationError("ID required for update", "id");
//                   await repos.customerRepository.updateWithValidation(op.id, op.data);
//                   results.customers.push({ id: op.id, ...op.data });
//                   break;
//                 case 'delete':
//                   if (!op.id) throw new ValidationError("ID required for delete", "id");
//                   await repos.customerRepository.delete(op.id);
//                   results.customers.push({ id: op.id, deleted: true });
//                   break;
//               }
//             } catch (error) {
//               errors.push(`Customer ${op.operation}: ${error instanceof Error ? error.message : String(error)}`);
//             }
//           }
//         }
...
//               switch (op.operation) {
//                 case 'create':
//                   const product = await repos.productRepository.createWithValidation(op.data);
//                   results.products.push(product);
//                   break;
//                 case 'update':
//                   if (!op.id) throw new ValidationError("ID required for update", "id");
//                   await repos.productRepository.updateWithValidation(op.id, op.data);
...
//               }
//             } catch (error) {
//               errors.push(`Product ${op.operation}: ${error instanceof Error ? error.message : String(error)}`);
//             }
//           }
//         }
...
//               switch (op.operation) {
//                 case 'create':
//                   const transaction = await repos.transactionRepository.createWithValidation(op.data);
//                   results.transactions.push(transaction);
//                   break;
//                 case 'update':
//                   if (!op.id) throw new ValidationError("ID required for update", "id");
//                   await repos.transactionRepository.updateWithValidation(op.id, op.data);
...
//               }
//             } catch (error) {
//               errors.push(`Transaction ${op.operation}: ${error instanceof Error ? error.message : String(error)}`);
//             }
//           }
//         }
//       });
...
//         success: false,
//         results,
//         errors: [...errors, `Bulk operation failed: ${error instanceof Error ? error.message : String(error)}`],
//       };
//     }
//   }
...
//         this.config.enableAuditLog ? this.getAuditLogCount(db) : Promise.resolve(0),
//       ]);
...
//           instanceTypes: Array.from(this.instances.keys()).map(key => key.split('_')[0]),
//         },
//       };
//     } catch (error) {
...
// export function createRepositoryFactory(config?: Partial<RepositoryConfig>): typeof EnhancedRepositoryFactory {
//   if (config) {
